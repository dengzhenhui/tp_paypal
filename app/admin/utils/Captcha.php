...
class Captcha
{
    ...
    function __construct()
    {
        $rand = rand(0, 1);
        if ($rand == 0) {
            $this->font = APP_PATH . 'adminstatic' . DIRECTORY_SEPARATOR . 'font' . DIRECTORY_SEPARATOR . 'elephant.ttf';
        } else {
            $this->font = APP_PATH . 'adminstatic' . DIRECTORY_SEPARATOR . 'font' . DIRECTORY_SEPARATOR . 'Vineta.ttf';
        }
    }
    ...
    public function doimage()
    {
        ...
        //session('Code', strtolower($code),600);
